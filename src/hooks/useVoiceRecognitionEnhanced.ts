...
export const useVoiceRecognitionEnhanced = ({
  ...
  const transcribeWithWhisper = useCallback(async (audioBlob: Blob): Promise<TranscriptionResult> => {
    ...
    try {
      ...
      // Debug logging
      console.log('🔍 [DEBUG] Hook sending parameters:', {
        autoDetect: autoDetectLanguage,
        translate: translateToEnglish,
        language: language
      });
      console.log('🔍 [DEBUG] FormData translate parameter:', formData.get('translate'));
  ...
  }, [autoDetectLanguage, language, translateToEnglish]);
