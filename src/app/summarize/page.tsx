      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold text-gray-800">Recent Flashcard Sets</h2>
            <Link 
          ...
          {isLoadingFlashcards ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {flashcardSets.map((set) => (
                <div key={set.id} className="bg-white p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-all duration-300 group">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      <h3 className="text-lg font-semibold text-gray-800 mb-2 group-hover:text-blue-600 transition-colors">
                        {set.title}
                      </h3>
                      <p className="text-gray-600 text-sm mb-3">{set.topic}</p>
                    </div>
                    {set.difficulty && (
                  ...
                  <div className="flex gap-2">
                    <Link 
                      href={`/summarize/flashcards/study/${set.id}`}
                    ...
                    <Link 
                      href={`/summarize/flashcards/edit/${set.id}`}
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-gray-600 mb-2">No flashcard sets yet</h3>
              <p className="text-gray-500 mb-4">Create your first flashcard set to start studying</p>
              <Link 
                href="/summarize/flashcards"
