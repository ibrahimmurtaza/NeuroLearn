  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col lg:flex-row">
      ...
      <div className="flex-1 flex flex-col relative bg-gradient-to-br from-slate-50 to-blue-50 min-h-screen lg:min-h-0">
        ...
        {/* Chat Messages Area - Fixed Height with Scroll - Adjusted for Voice Input */}
         <div className={`flex-1 relative overflow-hidden transition-all duration-300 ${
           (isRecording || transcript || isProcessing) ? 'pb-20' : 'pb-0'
         }`}>
        ...
        {/* Voice Input Indicator - Positioned Above Chat Input */}
        {(isRecording || transcript || isProcessing) && (
          <div className="absolute bottom-full left-0 right-0 z-10 p-3 lg:p-4">
            <div className="max-w-4xl mx-auto">
              <VoiceInputIndicator
                ...
                className="bg-white/95 backdrop-blur-sm rounded-xl p-3 border border-gray-200 shadow-lg animate-slideUp"
              />
            </div>
          </div>
        )}
        ...
        {/* Fixed Chat Input */}
        <div className="bg-white/90 backdrop-blur-sm border-t border-gray-200/50 p-3 lg:p-4 sticky bottom-0 relative">
          <div className="max-w-4xl mx-auto">
                    ...
                    {isSupported && (transcriptionMethod === 'whisper' || transcriptionMethod === 'hybrid') && (
                      <label className="flex items-center gap-2 text-xs text-gray-600 cursor-pointer">
                        <input
                          ...
                          onChange={(e) => {
                            console.log('🔍 [DEBUG] Toggle changed - translateToEnglish:', e.target.checked);
